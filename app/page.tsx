    ...
    <nav className="nav">
      <div className="nav__wrapper">
        ...
        <ul className="nav__list--wrapper">
          <li className="nav__list nav__list--login" onClick={() => dispatch(openAuthModal('login'))}>Login</li>
        ...
        <div className="row">
          <div className="landing__wrapper">
            <div className="landing__content">
              ...
              <button className="btn home__cta--btn" onClick={() => dispatch(openAuthModal('login'))}>Login</button>
            </div>
            <figure className="landing__image--mask">
              <Image priority={true} src={Landing} alt="landing" />
            </figure>
          </div>
        </div>
      </div>
